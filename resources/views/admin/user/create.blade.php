...
<article class="cl pd-20">
    <form action="{{url('/admin/user')}}" method="post" class="form form-horizontal" id="form-admin-add">
        {{csrf_field()}}
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{old('nickname')}}" placeholder="" id="nickname" name="nickname">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  value="{{old('email')}}"  placeholder="@" name="email" id="email">
            </div>
        </div>
        <div class="row cl">
